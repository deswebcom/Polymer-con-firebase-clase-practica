# Polymer y Firebase Mapas

Esto es un Polymer Starter Kit al que le hemos agregado una funcionalidad para realización de un mapa y sus marcas.

El código de esta aplicación se realizó en vivo, en una clase que se puede ver en este vídeo de Youtube:

https://youtu.be/T49xXBQ0aoQ

A continuación tienes el Readme del Polymer Starter Kit:
